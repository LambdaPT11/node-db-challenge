...
- [x] Explain the difference between `Relational Databases` and `SQL`.
  ...
  - Relational databases store persistant data and sql is a language used to manipulate that data

- [x] Why do tables need a `primary key`?

  - It uniquily identifies the record in the database.
